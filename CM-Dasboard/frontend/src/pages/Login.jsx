    ...
    <AnimatedPage className="min-h-screen flex items-center justify-center bg-slate-50 relative overflow-hidden px-4">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none z-0">
        ...
        <motion.div 
          ...
          className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[50%] rounded-full bg-indigo-500/20 blur-[120px]" 
        />
      </div>
      ...
      >
        <div className="text-center mb-8 space-y-4">
          <motion.div 
            ...
            className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-white text-blue-600 mb-2 shadow-sm border border-slate-100"
          >
            <UserCircle2 className="w-8 h-8" />
          </motion.div>
          <h1 className="text-3xl font-extrabold text-slate-900 tracking-tight">Welcome Back</h1>
          <p className="text-slate-500 font-medium">Log in to your GovConnect account</p>
        </div>
            ...
            <div className="space-y-1.5 group">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-11 pr-4 py-3.5 bg-white border border-slate-200 rounded-xl focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 outline-none transition-all shadow-sm placeholder:text-slate-400 text-slate-800 font-medium"
                />
              </div>
            </div>

            <div className="space-y-1.5 group">
              <label className="text-sm font-semibold text-slate-700 ml-1 group-focus-within:text-blue-600 transition-colors">Password</label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
